...
router.get("/chb/:chbId", auth_handler_1.JWTAuth, (0, validator_handler_1.default)(getScheduledNotificationsUsersByChbSchema, "params"), scheduled_notifications_users_controller_1.getNotificationsUsersByChbController);
