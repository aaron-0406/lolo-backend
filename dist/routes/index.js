...
const scheduled_notification_routes_1 = __importDefault(require("./config/scheduled-notification.routes"));
...
const routerApi = (app) => {
    ...
    router.use("/config/scheduled-notification", scheduled_notification_routes_1.default);
