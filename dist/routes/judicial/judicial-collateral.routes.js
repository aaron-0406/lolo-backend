...
const { getJudicialCollateralByIDSchema, createJudicialCollateralSchema, updateJudicialCollateralSchema, getJudicialCollateralByJudicialCaseFileIdSchema, } = judicial_collateral_schema_1.default;
const router = express_1.default.Router();
router.get("/:id", auth_handler_1.JWTAuth, (0, validator_handler_1.default)(getJudicialCollateralByIDSchema, "params"), judicial_collateral_controller_1.getCollateralByIDController);
router.get("/all/:JudicialCaseFileId", auth_handler_1.JWTAuth, (0, validator_handler_1.default)(getJudicialCollateralByJudicialCaseFileIdSchema, "params"), judicial_collateral_controller_1.getCollateralByJudicialCaseFileIdController);
