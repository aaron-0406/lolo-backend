...
router.post("/", auth_handler_1.JWTAuth, (0, validator_handler_1.default)(createJudicialRegisterOfficeSchema, "body"), judicial_register_office_controller_1.createRegisterOfficeController);
router.patch("/:id", auth_handler_1.JWTAuth, (0, validator_handler_1.default)(updateJudicialRegisterOfficeSchema, "body"), judicial_register_office_controller_1.updateRegisterOfficeController);
router.delete("/:id", auth_handler_1.JWTAuth, (0, validator_handler_1.default)(getJudicialRegisterOfficeByIDSchema, "params"), judicial_register_office_controller_1.deletedRegisterOfficeController);
