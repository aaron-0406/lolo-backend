...
const { createJudicialCollateralAuctionRoundSchema, updateJudicialCollateralAuctionRoundSchema, deleteJudicialCollateralAuctionRoundSchema, getJudicialCollateralAuctionRoundByIdSchema, getJudicialCollateralAuctionRoundByCaseFileIdSchema } = judicial_collateral_auction_round_schema_1.default;
...
router.get("/:caseFileId", auth_handler_1.JWTAuth, (0, validator_handler_1.default)(getJudicialCollateralAuctionRoundByCaseFileIdSchema, "params"), judicial_collateral_auction_round_controller_1.getAllJudicialAuctionsByCaseFileIdController);
