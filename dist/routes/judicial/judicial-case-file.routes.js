...
router.post("/qr-code/:numberCaseFile/:chb", auth_handler_1.JWTAuth, (0, validator_handler_1.default)(createQrCodeSchema, "params"), judicial_case_file_controller_1.createQrCodeToCaseFileController);
