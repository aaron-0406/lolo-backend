...
router.get("/number-case/:id", auth_handler_1.JWTAuth, (0, validator_handler_1.default)(getJudicialCaseFileByNumberCaseFileSchema, "params"), judicial_case_file_controller_1.getJudicialCaseFileByNumberCaseFileController);
