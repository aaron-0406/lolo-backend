...
const { getJudicialCaseFileByClientIDSchema, getJudicialCaseFileByIDSchema, getJudicialCaseFileByNumberCaseFileSchema, createJudicialCaseFileSchema, updateJudicialCaseFileSchema, } = judicial_case_file_schema_1.default;
...
router.get("/number-case/:code", auth_handler_1.JWTAuth, (0, validator_handler_1.default)(getJudicialCaseFileByNumberCaseFileSchema, "params"), judicial_case_file_controller_1.getJudicialCaseFileByNumberCaseFileController);
