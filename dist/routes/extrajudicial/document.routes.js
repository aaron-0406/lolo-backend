...
const document_schema_1 = __importDefault(require("../../app/extrajudicial/schemas/document.schema"));
const validator_handler_1 = __importDefault(require("../../middlewares/validator.handler"));
const document_controller_1 = require("../../controllers/extrajudicial/document.controller");
