...
router.post("/", auth_handler_1.JWTAuth, (0, auth_handler_1.checkPermissions)("P03-09-01"), (0, validator_handler_1.default)(product_schema_1.createProductSchema, "body"), product_controller_1.createProductController);
router.put("/:id", auth_handler_1.JWTAuth, (0, auth_handler_1.checkPermissions)("P03-09-02"), (0, validator_handler_1.default)(product_schema_1.getProductByIdSchema, "params"), (0, validator_handler_1.default)(product_schema_1.updateProductSchema, "body"), product_controller_1.updateProductController);
...
router.delete("/:id", auth_handler_1.JWTAuth, (0, auth_handler_1.checkPermissions)("P03-09-03"), (0, validator_handler_1.default)(product_schema_1.getProductByIdSchema, "params"), product_controller_1.deleteProductController);
