...
router.get("/case-file/:judicialCaseFileId", auth_handler_1.JWTAuth, (0, validator_handler_1.default)(product_schema_1.getProductsByJudicialCaseFileIdSchema, "params"), product_controller_1.getProductsByJudicialCaseFileController);
router.post("/assign-case-files/", auth_handler_1.JWTAuth, (0, auth_handler_1.checkPermissions)("P02-02-06-01"), //TODO: Change this permission
(0, validator_handler_1.default)(product_schema_1.assignJudicialCaseFileToProductsSchema, "body"), product_controller_1.assignJudicialCaseFileToProductsController);
router.post("/remove-case-file/", auth_handler_1.JWTAuth, (0, auth_handler_1.checkPermissions)("P02-02-06-01"), //TODO: Change this permission
(0, validator_handler_1.default)(product_schema_1.removeJudicialCaseFileFromProductSchema, "body"), product_controller_1.removeJudicialCaseFileFromProductController);
