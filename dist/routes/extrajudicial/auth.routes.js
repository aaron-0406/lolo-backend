...
router.post("/change-password", auth_handler_1.JWTAuth, (0, validator_handler_1.default)(changePasswordSchema, "body"), auth_controller_1.changePasswordController);
router.post("/change-credentials", auth_handler_1.JWTAuth, (0, validator_handler_1.default)(changeCredentialsSchema, "body"), auth_controller_1.changeCredentialsController);
