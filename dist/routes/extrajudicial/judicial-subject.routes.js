...
const judicial_subject_schema_1 = __importDefault(require("../../app/extrajudicial/schemas/judicial-subject.schema"));
const judicial_subject_controller_1 = require("../../controllers/extrajudicial/judicial-subject.controller");
const auth_handler_1 = require("../../middlewares/auth.handler");
const { getJudicialSubjectByIDSchema, createJudicialSubjectSchema, updateJudicialSubjectSchema, } = judicial_subject_schema_1.default;
