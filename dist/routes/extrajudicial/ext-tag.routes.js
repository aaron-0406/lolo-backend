...
const { getExtTagByCHBSchema, getExtTagByCHBAndTagGroupIdSchema, getExtTagByIDSchema, createExtTagSchema, updateExtTagSchema, updateExtTagActionSchema, } = ext_tag_schema_1.default;
...
router.get("/all-data-by-chb-and-tag-group-id/:chb/:tagGroupId", auth_handler_1.JWTAuth, (0, validator_handler_1.default)(getExtTagByCHBAndTagGroupIdSchema, "params"), ext_tag_controller_1.getExtTagsByCHBAndTagGroupIdController);
