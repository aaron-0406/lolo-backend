...
const { getExtTagGroupByIDSchema, createExtTagGroupSchema, updateExtTagGroupSchema, } = ext_tag_group_schema_1.default;
const router = express_1.default.Router();
router.get("/", auth_handler_1.JWTAuth, ext_tag_group_controller_1.getExtTagGroupController);
router.get("/all-data-with-order", auth_handler_1.JWTAuth, ext_tag_group_controller_1.getExtTagGroupByCHBController);
