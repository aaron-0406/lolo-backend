...
const { getClientByCHBSchema, getClientByCodeSchema, createClientSchema, updateClientSchema, getClientByCustomer, deleteClientByCodeSchema, getClientByCHBSchemaQuery, getClientByNameSchemaQuery, getDateSchema, } = client_schema_1.default;
...
router.post("/:idCustomer", auth_handler_1.JWTAuth, (0, auth_handler_1.checkPermissions)("P03-02"), (0, validator_handler_1.default)(getClientByCustomer, "params"), (0, validator_handler_1.default)(createClientSchema, "body"), client_controller_1.createClientController);
router.patch("/:code/:chb", auth_handler_1.JWTAuth, (0, auth_handler_1.checkPermissions)("P03-03"), (0, validator_handler_1.default)(getClientByCodeSchema, "params"), (0, validator_handler_1.default)(updateClientSchema, "body"), client_controller_1.updateClientController);
router.delete("/:code/:chb/:idCustomer", auth_handler_1.JWTAuth, (0, auth_handler_1.checkPermissions)("P03-04"), (0, validator_handler_1.default)(deleteClientByCodeSchema, "params"), client_controller_1.deleteClientController);
