...
router.post("/:idCustomer", auth_handler_1.JWTAuth, (0, auth_handler_1.checkPermissions)("P02-03"), (0, validator_handler_1.default)(getClientByCustomer, "params"), (0, validator_handler_1.default)(createClientSchema, "body"), client_controller_1.createClientController);
router.patch("/:code/:chb", auth_handler_1.JWTAuth, (0, auth_handler_1.checkPermissions)("P02-04"), (0, validator_handler_1.default)(getClientByCodeSchema, "params"), (0, validator_handler_1.default)(updateClientSchema, "body"), client_controller_1.updateClientController);
