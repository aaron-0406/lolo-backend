...
router.post("/", auth_handler_1.JWTAuth, (0, validator_handler_1.default)(createGuarantorSchema, "body"), guarantor_controller_1.createGuarantorController);
router.patch("/:id", auth_handler_1.JWTAuth, (0, validator_handler_1.default)(getGuarantorByIDSchema, "params"), (0, validator_handler_1.default)(updateGuarantorSchema, "body"), guarantor_controller_1.updateGuarantorController);
router.delete("/:id", auth_handler_1.JWTAuth, (0, validator_handler_1.default)(getGuarantorByIDSchema, "params"), guarantor_controller_1.deleteGuarantorController);
