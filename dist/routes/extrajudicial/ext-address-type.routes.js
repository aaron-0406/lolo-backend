...
const { createAddressTypeSchema, updateAddressTypeSchema, getAddressTypeByChbSchema, getAddressTypeByIDSchema, } = ext_address_type_schema_1.default;
const router = express_1.default.Router();
router.get("/", auth_handler_1.JWTAuth, ext_address_type_controller_1.getAllAddressTypesController);
router.get("/chb/:chb", auth_handler_1.JWTAuth, (0, validator_handler_1.default)(getAddressTypeByChbSchema, "params"), ext_address_type_controller_1.getAddressTypeByCHBController);
router.get("/:id", auth_handler_1.JWTAuth, (0, validator_handler_1.default)(getAddressTypeByIDSchema, "params"), ext_address_type_controller_1.getAddressTypeByIdController);
...
router.delete("/:id", auth_handler_1.JWTAuth, (0, auth_handler_1.checkPermissions)("P16-03"), (0, validator_handler_1.default)(getAddressTypeByIDSchema, "params"), ext_address_type_controller_1.deleteAddressTypeController);
