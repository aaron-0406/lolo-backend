...
router.post("/", auth_handler_1.JWTAuth, (0, auth_handler_1.checkPermissions)("P02-02-05-01"), (0, validator_handler_1.default)(createDirectionSchema, "body"), direction_controller_1.createDirectionController);
router.patch("/:id", auth_handler_1.JWTAuth, (0, auth_handler_1.checkPermissions)("P02-02-05-02"), (0, validator_handler_1.default)(getDirectionByIDSchema, "params"), (0, validator_handler_1.default)(updateDirectionSchema, "body"), direction_controller_1.updateDirectionController);
router.delete("/:id", auth_handler_1.JWTAuth, (0, auth_handler_1.checkPermissions)("P02-02-05-03"), (0, validator_handler_1.default)(getDirectionByIDSchema, "params"), direction_controller_1.deleteDirectionController);
