...
const judicial_procedural_way_schema_1 = __importDefault(require("../../app/extrajudicial/schemas/judicial-procedural-way.schema"));
const judicial_procedural_way_controller_1 = require("../../controllers/extrajudicial/judicial-procedural-way.controller");
const auth_handler_1 = require("../../middlewares/auth.handler");
const { getJudicialProceduralWayByIDSchema, createJudicialProceduralWaySchema, updateJudicialProceduralWaySchema, } = judicial_procedural_way_schema_1.default;
