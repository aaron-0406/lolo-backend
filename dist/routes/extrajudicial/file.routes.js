...
const { createFileSchema, updateFileSchema, deleteFileSchema, getFileSchema, getFileByIdSchema, getFileFilterByIdAndChbSchema, getUserLogsFilterByCustomerIdQuery } = file_schema_1.default;
...
router.get("/:id/chb/:chb", auth_handler_1.JWTAuth, (0, validator_handler_1.default)(getFileFilterByIdAndChbSchema, "params"), (0, validator_handler_1.default)(getUserLogsFilterByCustomerIdQuery, "query"), file_controller_1.findFileByClientIdController);
