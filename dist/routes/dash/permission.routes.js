...
const permission_schema_1 = __importDefault(require("../../app/boss/schemas/permission.schema"));
const permission_controller_1 = require("../../controllers/dash/permission.controller");
const auth_handler_1 = require("../../middlewares/auth.handler");
const { getPermissionByIdSchema, createPermissionSchema, updatePermissionSchema, } = permission_schema_1.default;
const router = express_1.default.Router();
router.get("/", auth_handler_1.JWTAuth, permission_controller_1.getAllPermissionController);
