...
const { getCustomerByUrlSchema, createCustomerSchema, getCustomerByID, updateCustomerSchema, updateStateCustomerSchema, updateScrapperStateCustomerSchema } = customer_schema_1.default;
...
router.put("/scrapper-state/:id", auth_handler_1.JWTAuth, (0, validator_handler_1.default)(getCustomerByID, "params"), (0, validator_handler_1.default)(updateScrapperStateCustomerSchema, "body"), customer_controller_1.updateCustomerScrapperStateController);
