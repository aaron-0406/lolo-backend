...
router.post("/", auth_handler_1.JWTAuth, (0, auth_handler_1.checkPermissions)("P08-01"), (0, validator_handler_1.default)(createFuncionarioSchema, "body"), funcionario_controller_1.createFuncionarioController);
router.put("/:id", auth_handler_1.JWTAuth, (0, auth_handler_1.checkPermissions)("P08-02"), (0, validator_handler_1.default)(getFuncionarioSchema, "params"), (0, validator_handler_1.default)(updateFuncionarioSchema, "body"), funcionario_controller_1.updateFuncionarioController);
router.delete("/:id", auth_handler_1.JWTAuth, (0, auth_handler_1.checkPermissions)("P08-03"), (0, validator_handler_1.default)(getFuncionarioSchema, "params"), funcionario_controller_1.deleteFuncionarioController);
