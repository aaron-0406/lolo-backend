...
router.post("/", auth_handler_1.JWTAuth, (0, validator_handler_1.default)(createNegotiationSchema, "body"), negotiation_controller_1.createNegotiationController);
router.put("/:id", auth_handler_1.JWTAuth, (0, validator_handler_1.default)(getNegotiationSchema, "params"), (0, validator_handler_1.default)(updateNegotiationSchema, "body"), negotiation_controller_1.updateNegotiationController);
router.delete("/:id", auth_handler_1.JWTAuth, (0, validator_handler_1.default)(getNegotiationSchema, "params"), negotiation_controller_1.deleteNegotiationController);
