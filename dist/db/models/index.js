...
const customer_has_bank_model_1 = __importDefault(
  require('./many-to-many/customer-has-bank.model')
);
...
const management_action_model_1 = __importDefault(
  require('./management-action.model')
);
const comment_model_1 = __importDefault(require('./comment.model'));
const ext_address_type_model_1 = __importDefault(
  require('./ext-address-type.model')
);
...
const template_has_values_model_1 = __importDefault(
  require('./many-to-many/template-has-values.model')
);
...
const role_permission_model_1 = __importDefault(
  require('./many-to-many/role-permission.model')
);
const judicial_case_file_model_1 = __importDefault(
  require('./judicial-case-file.model')
);
const judicial_subject_model_1 = __importDefault(
  require('./judicial-subject.model')
);
const judicial_court_model_1 = __importDefault(
  require('./judicial-court.model')
);
const judicial_procedural_way_model_1 = __importDefault(
  require('./judicial-procedural-way.model')
);
const user_log_model_1 = __importDefault(require('./user-log.model'));
const ext_ip_address_bank_model_1 = __importDefault(
  require('./ext-ip-address-bank.model')
);
const ext_contact_type_model_1 = __importDefault(
  require('./ext-contact-type.model')
);
const judicial_obs_type_model_1 = __importDefault(
  require('./judicial-obs-type.model')
);
const judicial_observation_model_1 = __importDefault(
  require('./judicial-observation.model')
);
const judicial_obs_file_model_1 = __importDefault(
  require('./judicial-obs-file.model')
);
const ext_product_name_model_1 = __importDefault(
  require('./ext-product-name.model')
);
const judicial_binnacle_model_1 = __importDefault(
  require('./judicial-binnacle.model')
);
const judicial_bin_procedural_stage_model_1 = __importDefault(
  require('./judicial-bin-procedural-stage.model')
);
const judicial_bin_type_binnacle_model_1 = __importDefault(
  require('./judicial-bin-type-binnacle.model')
);
const judicial_bin_file_model_1 = __importDefault(
  require('./judicial-bin-file.model')
);
const judicial_process_reason_model_1 = __importDefault(
  require('./judicial-process-reason.model')
);
const scheduled_notifications_model_1 = __importDefault(
  require('./settings/scheduled-notifications.model.')
);
const scheduled_notifications_users_model_1 = __importDefault(
  require('./settings/scheduled-notifications-users.model')
);
...
const { ManagementAction, ManagementActionSchema } =
  management_action_model_1.default;
...
const { TemplateHasValues, TemplateHasValuesSchema } =
  template_has_values_model_1.default;
const { Values, ValuesSchema } = values_model_1.default;
const { CustomerHasBank, CustomerHasBankSchema } =
  customer_has_bank_model_1.default;
...
const { RolePermission, RolePermissionSchema } =
  role_permission_model_1.default;
const { JudicialSubject, JudicialSubjectSchema } =
  judicial_subject_model_1.default;
...
const { JudicialProceduralWay, JudicialProceduralWaySchema } =
  judicial_procedural_way_model_1.default;
const { UserLog, UserLogSchema } = user_log_model_1.default;
const { JudicialCaseFile, JudicialCaseFileSchema } =
  judicial_case_file_model_1.default;
const { ExtIpAddressBank, ExtIpAddressBankSchema } =
  ext_ip_address_bank_model_1.default;
const { ExtContactType, ExtContactTypeSchema } =
  ext_contact_type_model_1.default;
const { JudicialObsType, JudicialObsTypeSchema } =
  judicial_obs_type_model_1.default;
const { JudicialObservation, JudicialObservationSchema } =
  judicial_observation_model_1.default;
const { JudicialObsFile, JudicialObsFileSchema } =
  judicial_obs_file_model_1.default;
const { ExtProductName, ExtProductNameSchema } =
  ext_product_name_model_1.default;
const { JudicialBinnacle, JudicialBinnacleSchema } =
  judicial_binnacle_model_1.default;
const { JudicialBinProceduralStage, JudicialBinProceduralStageSchema } =
  judicial_bin_procedural_stage_model_1.default;
const { JudicialBinTypeBinnacle, JudicialBinTypeBinnacleSchema } =
  judicial_bin_type_binnacle_model_1.default;
const { JudicialBinFile, JudicialBinFileSchema } =
  judicial_bin_file_model_1.default;
const { JudicialProcessReason, JudicialProcessReasonSchema } =
  judicial_process_reason_model_1.default;
const { ScheduledNotifications, ScheduledNotificationsSchema } =
  scheduled_notifications_model_1.default;
const { ScheduledNotificationsUsers, ScheduledNotificationsUsersSchema } =
  scheduled_notifications_users_model_1.default;
