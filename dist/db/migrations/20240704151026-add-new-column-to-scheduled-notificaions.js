...
function up(queryInterface) {
    return __awaiter(this, void 0, void 0, function* () {
        yield queryInterface.addColumn(SCHEDULED_NOTIFICATIONS_TABLE, "days_to_notify", {
            allowNull: true,
...
function down(queryInterface) {
    return __awaiter(this, void 0, void 0, function* () {
        yield queryInterface.removeColumn(SCHEDULED_NOTIFICATIONS_TABLE, "days_to_notify");
    });
}
exports.down = down;
