...
function up(queryInterface) {
    return __awaiter(this, void 0, void 0, function* () {
        yield queryInterface.addColumn(JUDICIAL_CASE_FILE_TABLE, "customer_has_bank_id", {
            allowNull: false,
...
function down(queryInterface) {
    return __awaiter(this, void 0, void 0, function* () {
        yield queryInterface.removeColumn(JUDICIAL_CASE_FILE_TABLE, "customer_has_bank_id");
    });
}
exports.down = down;
