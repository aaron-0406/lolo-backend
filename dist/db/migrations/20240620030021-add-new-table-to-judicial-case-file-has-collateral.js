...
const judicial_case_file_has_collateral_model_1 = __importDefault(require("../models/judicial-case-file-has-collateral.model"));
...
function up(queryInterface) {
    return __awaiter(this, void 0, void 0, function* () {
        yield queryInterface.createTable(JUDICIAL_CASE_FILE_HAS_COLLATERAL_TABLE, {
            id: {
                primaryKey: true,
                allowNull: false,
                autoIncrement: true,
...
function down(queryInterface) {
    return __awaiter(this, void 0, void 0, function* () {
        yield queryInterface.dropTable(JUDICIAL_CASE_FILE_HAS_COLLATERAL_TABLE);
    });
}
exports.down = down;
