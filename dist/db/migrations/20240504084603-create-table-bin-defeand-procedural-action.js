...
function up(queryInterface) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        yield queryInterface.addColumn(JUDICIAL_BINNACLE_TABLE, "id_defendant_procedural_action", {
            allowNull: true,
            field: "id_defendant_procedural_action",
            type: sequelize_1.DataTypes.INTEGER,
            references: {
...
function down(queryInterface) {
    return __awaiter(this, void 0, void 0, function* () {
        yield queryInterface.removeColumn(JUDICIAL_BINNACLE_TABLE, "defendant_procedural_action_id_defendant_procedural_action");
