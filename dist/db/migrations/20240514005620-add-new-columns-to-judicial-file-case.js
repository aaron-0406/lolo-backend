...
function up(queryInterface) {
    return __awaiter(this, void 0, void 0, function* () {
        yield queryInterface.addColumn(JUDICIAL_CASE_FILE_TABLE, "id_judicial_case_file_related", {
            allowNull: true,
        ...
        yield queryInterface.addColumn(JUDICIAL_CASE_FILE_TABLE, "id_bank", {
            allowNull: true,
            field: "id_bank",
            type: sequelize_1.DataTypes.INTEGER,
            references: {
...
function down(queryInterface) {
    return __awaiter(this, void 0, void 0, function* () {
        yield queryInterface.removeColumn(JUDICIAL_CASE_FILE_TABLE, "id_judicial_case_file_related");
        yield queryInterface.removeColumn(JUDICIAL_CASE_FILE_TABLE, "id_bank");
    });
}
exports.down = down;
