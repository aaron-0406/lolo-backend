...
const getAllUserLogsController = (req, res, next) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        const userLogs = yield service.findAll();
        res.json(userLogs);
    }
    catch (error) {
        next(error);
...
exports.getAllUserLogsController = getAllUserLogsController;
const getAllUserLogsByCustomerIdController = (req, res, next) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        const { customerId } = req.params;
        const userLogs = yield service.findAllByCustomerId(customerId);
        res.json(userLogs);
    }
    catch (error) {
        next(error);
