...
const scheduled_notification_service_1 = __importDefault(require("../../app/settings/services/scheduled-notification.service"));
const service = new scheduled_notification_service_1.default();
